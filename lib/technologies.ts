...
export const technologies = define({
  ...
  javascript: { name: "JavaScript", icon: SiJavascript, website: "https://developer.mozilla.org/docs/Web/JavaScript", brand: "#f7df1e" },
  java: { name: "Java", icon: SiOpenjdk, website: "https://openjdk.org", brand: "#e76f00" },
  vite: { name: "Vite", icon: SiVite, website: "https://vite.dev", brand: "#646cff" },
  d3: { name: "D3", icon: SiD3, website: "https://d3js.org", brand: "#f9a03c" },
  webWorkers: { name: "Web Workers", website: "https://developer.mozilla.org/docs/Web/API/Web_Workers_API" },
  convex: { name: "Convex", website: "https://www.convex.dev", brand: "#f3b01c" },
  groq: { name: "Groq", website: "https://groq.com", brand: "#f55036" },
  gptOss: { name: "GPT-OSS 120B", icon: SiOpenai, website: "https://openai.com/open-models/", brand: "#ffffff" },
  contextDev: { name: "Context.dev", website: "https://context.dev", brand: "#ff6b35" },
  npmRegistry: { name: "npm Registry", icon: SiNpm, website: "https://www.npmjs.com", brand: "#cb3837" },
  pypi: { name: "PyPI", icon: SiPypi, website: "https://pypi.org", brand: "#3775a9" },
  osv: { name: "OSV", website: "https://osv.dev", brand: "#4285f4" },
  tailwind: {
    name: "Tailwind CSS",
    icon: SiTailwindcss,
